      ...
      <section className="py-16 md:py-24 bg-black-light">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-cream/60">{t.about.subtitle}</p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <span className="text-gold text-sm font-medium tracking-wider uppercase">Our Story</span>
              <h2 className="font-serif text-3xl md:text-4xl font-bold text-cream">
                {language === "en" ? "Our Journey" : "ഞങ്ങളുടെ യാത്ര"}
              </h2>
              <div className="w-16 h-1 bg-gradient-to-r from-gold-dark via-gold to-gold-light" />
      ...
      <section className="py-16 md:py-24 bg-black-light">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <div className="w-20 h-1 bg-gradient-to-r from-gold-dark via-gold to-gold-light mx-auto" />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {aboutData.values.map((value) => {
              ...
              return (
                <div
                  key={value.id}
                  className="group bg-black rounded-xl p-6 text-center border border-gold/20 hover:border-gold/50 transition-all duration-300 hover:shadow-xl hover:shadow-gold/10"
                >
                  <div className="w-12 h-12 rounded-full bg-gold/10 border border-gold/30 flex items-center justify-center mx-auto mb-4 group-hover:bg-gold/20 transition-colors">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1 space-y-6">
              <span className="text-gold text-sm font-medium tracking-wider uppercase">Leadership</span>
              <h2 className="font-serif text-3xl md:text-4xl font-bold text-cream">
                {t.about.founder.title}
              </h2>
              <div className="w-16 h-1 bg-gradient-to-r from-gold-dark via-gold to-gold-light" />
              <div>
                <h3 className="font-serif text-2xl font-semibold text-gold mb-1">
            ...
            <div className="order-1 lg:order-2 relative aspect-square max-w-md mx-auto lg:mx-0 lg:ml-auto">
              <div className="absolute inset-4 rounded-2xl bg-gold/20 border border-gold/30" />
              <div className="relative rounded-2xl overflow-hidden aspect-square border border-gold/30">
                <Image
