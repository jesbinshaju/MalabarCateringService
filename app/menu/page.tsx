...
export default function MenuPage() {
  ...
  return (
    <div className="flex flex-col pt-20 bg-black">
      ...
      <section className="py-16 md:py-24 bg-black">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-[#D4AF37]/60">{t.menu.subtitle}</p>
          </div>
        </div>
      </section>

      {/* Category Tabs */}
      <section className="sticky top-16 z-40 bg-black border-y border-[#D4AF37]/30">
        <div className="container mx-auto px-4">
              ...
              <button
                ...
                className={cn(
                  ...
                  activeCategory === category
                    ? "gold-gradient text-black shadow-lg gold-glow"
                    : "bg-transparent text-[#D4AF37]/60 border border-[#D4AF37]/30 hover:border-[#D4AF37] hover:text-[#D4AF37]"
                )}
              >
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredItems.map((item) => (
              <div
                key={item.id}
                className="group bg-black rounded-xl p-6 border border-[#D4AF37]/30 hover:border-[#D4AF37] hover:shadow-xl hover:shadow-[#D4AF37]/20 transition-all duration-300"
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      <h3 className="font-serif text-lg font-semibold text-[#FFD700] group-hover:text-white transition-colors">
                        {item.name[language]}
                      </h3>
                      {item.vegetarian && (
                        <span className="w-5 h-5 rounded-full bg-green-500/20 border border-green-500/50 flex items-center justify-center" title="Vegetarian">
      ...
      {/* Note Section */}
      <section className="py-12 bg-black border-t border-[#D4AF37]/30">
        <div className="container mx-auto px-4">
